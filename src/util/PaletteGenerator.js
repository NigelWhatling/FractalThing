const PaletteGenerator = (size) => {

    // Taken from https://en.wikipedia.org/wiki/Monotone_cubic_interpolation
    ...
    const interpolantR = createInterpolant([0.0, 0.16, 0.42, 0.6425, 0.8575, 1.0], [0, 32, 237, 255, 0, 0]);
    const interpolantG = createInterpolant([0.0, 0.16, 0.42, 0.6425, 0.8575, 1.0], [7, 107, 255, 170, 2, 0]);
    const interpolantB = createInterpolant([0.0, 0.16, 0.42, 0.6425, 0.8575, 1.0], [100, 203, 255, 0, 0, 100]);
